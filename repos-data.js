...
export const REPO_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      {
  name: "sql-xlsx-csv-scraper",
  href: "https://github.com/ginesthoii/sql-xlsx-csv-scraper",
  image: "https://github.com/ginesthoii/ginesthoii/blob/main/assets/two/scraper-sql-xlsx.jpg?raw=1",
  description: "Automation-first structured data harvester that ingests CSV/XLSX spreadsheets into SQL and exports normalized datasets back out for reporting, dashboards + offline workflows.",
  tech: ["Python"],
  status: "Active",
